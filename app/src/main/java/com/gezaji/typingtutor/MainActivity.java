...
public class MainActivity extends AppCompatActivity implements InputManager.InputDeviceListener {
    ...
    static final int C_LED_ON     = 0xFF22C55E;
    ...
    class KeyboardView extends View {
        ...
        private Key[][] buildRows() {
            return new Key[][] {
                ...
                },
                {
                    ...
                    k(KeyEvent.KEYCODE_NUMPAD_8,   1f,  "8",     "Up"),
                ...
                },
                {
                    ...
                    gap(0.25f),
                    k(KeyEvent.KEYCODE_NUMPAD_4,   1f,  "4",     "Left"),
                    k(KeyEvent.KEYCODE_NUMPAD_5,   1f,  "5",     ""),
                    k(KeyEvent.KEYCODE_NUMPAD_6,   1f,  "6",     "Right"),
                },
                {
                    ...
                    gap(0.25f),
                    gap(1f),
                    k(KeyEvent.KEYCODE_DPAD_UP,    1f,  "Up",    ""),
                    gap(1f),
                    gap(0.25f),
                    k(KeyEvent.KEYCODE_NUMPAD_1,   1f,  "1",     "End"),
                    k(KeyEvent.KEYCODE_NUMPAD_2,   1f,  "2",     "Dn"),
                ...
                },
                {
                    ...
                    gap(0.25f),
                    k(KeyEvent.KEYCODE_DPAD_LEFT,  1f,  "Left",  ""),
                    k(KeyEvent.KEYCODE_DPAD_DOWN,  1f,  "Down",  ""),
                    k(KeyEvent.KEYCODE_DPAD_RIGHT, 1f,  "Right", ""),
                    gap(0.25f),
        ...
        private void computeLayout() {
            ...
            keyH = Math.min(availH / (ROWS.length + 0.5f), keyUnit * 1.1f);
        ...
        private void drawKey(Canvas canvas, Key key, long now) {
            ...
            if (!key.sub.isEmpty() && key.w <= keyUnit * 1.1f) {
                ...
                canvas.drawText(key.sub, key.x + key.w - dp(3),
